"""
YouTube Upload Script for Velocity Turkish
"""
...
def upload_to_youtube(video_info):
    ...
    title = "Learn Turkish with Velocity Turkish"
    description = ""
    ...
    video_metadata = {
        "snippet": {"title": title, "description": description[:4800],
                     "tags": ["Learn Turkish", "Turkish Phrases", "Turkish Language", "Velocity Turkish", "Turkish for Beginners"],
                     "categoryId": "27"},
...
def main():
    print("VELOCITY TURKISH - YOUTUBE UPLOADER")
