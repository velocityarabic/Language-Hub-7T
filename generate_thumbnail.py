...
SCENIC_STYLES = [
    "stunning Turkish woman in traditional dress, Cappadocia fairy chimneys, sunrise balloons",
    "elegant Turkish woman in silk, Hagia Sophia, Istanbul skyline, golden morning light",
    "beautiful Turkish woman in modern attire, Bosphorus bridge, Istanbul cityscape",
    "Turkish girl at Pamukkale travertines, white terraces, golden hour",
    "gorgeous Turkish woman in traditional attire, Ephesus ruins, warm sunset light",
    "beautiful Turkish woman, Topkapi Palace garden, tulips spring bloom",
    "Turkish woman in traditional dress, Maiden's Tower, Bosphorus sunset",
    "elegant Turkish woman, Sultanahmet Mosque, serene atmosphere, blue hour",
]


def generate_scenic_image(category_english: str, category_turkish: str, output_path: str):
    if POLLINATIONS_API_KEY:
        for attempt in range(3):
            style = random.choice(SCENIC_STYLES)
            prompt = (
                f"Professional YouTube thumbnail for Turkish language learning video. "
                f"{style}. "
                ...
                f"At top: '120 TURKISH PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY TURKISH'. Also: '10 MINUTE LESSON' badge."
            )
            try:
    ...
    draw.text((960, 180), "120 TURKISH PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
